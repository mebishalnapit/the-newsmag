...
if (!function_exists('the_newsmag_footer_copyright')) :
    ...
    function the_newsmag_footer_copyright() {
        ...
        $my_link_name = '<a href="http://napitwptech.com/themes/the-newsmag/" target="_blank" title="' . esc_attr__('Bishal Napit', 'the-newsmag') . '"><span>' . esc_html__('Bishal Napit', 'the-newsmag') . '</span></a>';
